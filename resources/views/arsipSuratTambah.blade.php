                ...
                <div class="col-sm-6">
                    <div class="page-header float-left" style="background-color: #d4edda ;">
                        <div class="page-title" style="background-color: #d4edda ;">
                            <h4 style="margin-top:10px">Unggah Surat</h4>
            ...
            <div class="card">
                <div class="card-body card-block">
                    ...
                    <div class="align-text-center">
                        <h4 align="center">Form Unggah Surat</h4>
                    </div><br>
                    <div class="row"> 
                        <div class="col-md-1"></div>
                        <div class="col-md-10" style="justify-content-center">
                            <form action="{{route('tambah-arsip')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="nomorSurat" name="nomorSurat" placeholder="Masukkan Nomor Surat" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="kategoriSurat" id="kategoriSurat" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="judulSurat" name="judulSurat" placeholder="Masukkan Judul" class="form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="file" id="fileSurat" name="fileSurat" class="form-control-file" accept="application/pdf" required>
                                    </div>
                                </div>
